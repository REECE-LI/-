...
/********************* ST7735S内部实现 ***********************/
//LCD 的管脚定义
#define     LCD_ST7735S_WR      PTE11
#define     LCD_ST7735S_RD      PTE12
#define     LCD_ST7735S_CS      PTE8
#define     LCD_ST7735S_RS      PTA5
#define     LCD_ST7735S_RST     PTE9


///新车
//#if 1
//#define     LCD_ST7735R_WR      PTE11
//#define     LCD_ST7735R_RD      PTE12
//#define     LCD_ST7735R_CS      PTE8
//#define     LCD_ST7735R_RS      PTA5
//#define     LCD_ST7735R_RST     PTE9 
//#endif

//此部分需要修改初始化里的代码
//#define     LCD_ST7735S_P0              PTC_B0_OUT
//#define     LCD_ST7735S_PIN             PTC_B0_IN
//#define     LCD_ST7735S_PDDR_OUT()      (DDRE_B0 = 0xff)
//#define     LCD_ST7735S_PDDR_IN()       (DDRE_B0 = 0)

//此部分需要修改初始化里的代码
#define     LCD_ST7735S_P0              PTE_B0_OUT
#define     LCD_ST7735S_PIN             PTE_B0_IN
#define     LCD_ST7735S_PDDR_OUT()      (DDRE_B0 = 0xff)
#define     LCD_ST7735S_PDDR_IN()       (DDRE_B0 = 0)
